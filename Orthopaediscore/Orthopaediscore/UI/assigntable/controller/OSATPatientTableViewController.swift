...
/*
 这个病人列表控制器 使用在 分配量表 中， MT 缩写代表 Assign Table
 
 */

import UIKit

class OSATPatientTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let vc = OSATSelectedTBV.init(patient: self.patientList[indexPath.row])
